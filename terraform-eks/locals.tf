locals {
  ...
  # Usar apenas o primeiro NAT Gateway para reduzir custos e evitar problemas de AZ
  subnet_indices_for_nat  = [0]  # Apenas uma NAT Gateway na primeira AZ disponível
